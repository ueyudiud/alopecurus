...
ALO_EXPORT void (aloL_newtype_)(a_henv env, char const* name, aloL_Entry const* bs, a_usize nb);

#define aloL_newtype(env,name,bs) aloL_newtype_(env, name, bs, sizeof(bs) / sizeof(aloL_Entry))
