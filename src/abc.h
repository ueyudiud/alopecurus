...
/*================================================================================*/ \
    ...
    _( NEXTG, "nextg",reg,reg,len,___) /* t, R[a:a+c] := next(R[b:b+2])
                                          if R[a] { pc += 1; R[b+2] := t }        */ \
    _(NEXTGV,"nextgv",reg,reg,___,___) /* t, R[a:] := next(R[b:b+2])
                                          if t { pc += 1; R[b+2] := t }           */ \
    ...
    _(   POW,   "pow",reg,reg,reg,___) /* R[a] := R[b] ^ R[c]                     */ \
    ...
    _(  POWI,  "powi",reg,reg,int,___) /* R[a] := R[b] ^ int(c)                   */ \
