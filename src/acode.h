...
intern void ai_code_prefix(Parser* par, InoutExpr e, a_u32 op, a_u32 line);
intern void ai_code_infix(Parser* par, InoutExpr e, a_u32 op, a_u32 line);
intern void ai_code_suffix(Parser* par, InoutExpr e1, InExpr e2, a_u32 op, a_u32 line);
...
intern void ai_code_multi(Parser* par, Exprs* es, a_u32 op, a_u32 line);
intern void ai_code_take(Parser* par, Exprs* es, a_u32 n, a_u32 op, a_u32 line);

intern void ai_code_gotoD(Parser* par, a_u32 label, a_u32 line);
intern a_u32 ai_code_gotoU(Parser* par, a_u32 label, a_u32 line);
intern void ai_code_label(Parser* par, a_u32 label, a_u32 line);
...
intern GFunMeta* ai_code_epilogue(Parser* par, a_bool root);
...
/*==========================Duality Expression==========================*/
	...
	EXPR_TRUE,
	/**
	 ** The try expression with boolean type.
	...
	/**
	 ** The try expression.
	 ** REPR: try { R[_1] } else { nil }
	 *@param _1 the register index.
	 *@param _2 the label of jump instruction.
	 */
	EXPR_TRY_RN,
	/**
	 ** The try expression.
	 ** REPR: try { R[_label(a)] } else { nil }
	 *@param _1 the label of compute result instruction.
	 *@param _2 the label of jump instruction.
	 */
	EXPR_TRY_AN,
	/**
...
/*===========================Lazy Expressions===========================*/
	...
	EXPR_CREFK,
	/**
	 ** The unbox expression.
	 ** REPR: unbox(R[_reg])
	 *@param _reg the register index of the register hold unboxed value.
	 */
	EXPR_UNBOX,
/*=========================Partial Expressions==========================*/
	/**
...
/*==========================Result Expressions==========================*/
	 ...
	 ** REPR: R[_reg:top]
	 *@param _reg the base register index.
	 */
	EXPR_VAR_REG
};
...
/**
 ** REPR: R[_base:_base+_count-1], _last
 */
struct Exprs {
	a_u32 _base;
	a_u32 _count;
